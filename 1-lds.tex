...
\begin{frame}{What You Should Know}
    \begin{itemize}
        \item Describing search as a tree.

        \item In general, when and how often are heuristics wrong? (And do you expect this to be
            true for your particular problem?)

        \item What can we do about it?

        \item What effect does a discrepancy search have for solvable instances? What about
